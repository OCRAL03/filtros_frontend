  ...
  return (
    <footer>
      <div className="flex flex-col md:flex-row items-start justify-center px-6 md:px-16 lg:px-32 gap-10 py-14 border-b border-gray-500/30 text-gray-500">
        <div className="w-4/5">
          ...
          <p className="mt-6 text-sm">
            ...
            tipos de texto. Ha sido el texto estándar de la industria desde el
            siglo XVI, cuando un impresor desconocido usó una galería de textos
            y los mezcló para hacer un libro de muestras.
          </p>
        </div>
      ...
      <p className="py-4 text-center text-xs md:text-sm">
        Copyright 2025 © GreatStack.dev Todos los derechos reservados.
      </p>
    </footer>
  );
};
