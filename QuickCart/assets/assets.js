...
export const navCategories = [
  {
    ...
    items: [
      ...
      { name: "Equipos de audio", value: "Headphone" },
      { name: "Equipos de video", value: "Camera" },
      { name: "Televisores", value: "Accessories" },
    ],
  },
  {
    ...
    items: [
      ...
      { name: "Refrigeradoras", value: "Accessories" },
      { name: "Cocina", value: "Accessories" },
      { name: "Utensilios", value: "Accessories" },
    ],
  },
  {
    title: "Vehículos",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Flautas", value: "Accessories" },
    ],
  },
];